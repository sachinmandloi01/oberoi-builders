    ...
    <nav className="navbar">
      <div className="container">
        <div className="location-info">
          ...
          <h4>Vijay Nagar</h4><i class="fa fa-angle-down" aria-hidden="true"></i>
          <p>Indore</p>
          ...
          <div className="card reel-card" key={index}>
            ...
            <div className="imgBx">
              <div className="video-container">
                ...
                {isMuted && (
                  <div className="unmute-button" onClick={handleUnmute}>
                    <img src="/1234.png" alt="test" width={25} height={20} />
                  </div>
                )}
                {!isMuted && (
                  <div className="unmute-button" onClick={handleMute}>
                    <img src="/Speaker_Icon.svg.png" alt="test" width={25} height={20} />
                  </div>
                )}
              </div>
              ...
              <div className="actionBtns">
                ...
                <a href="https://wa.me/9669563039?text=Hello%2C%20I%20would%20like%20to%20know%20more%20about%20your%20services." target="_blank" rel="noopener noreferrer" className="btn">
                ...
                <img src={"/bitcoin-icons_share-outline.png"} height={33} width={33} />
